...
class SettingsMixin:
    ...
    def _set_tab_export(self, win):
        ...
        win.note(t("Ctrl+E and the copy button also save here — a new, numbered "
                   "file next to the photo. The original is never touched, and an "
                   "earlier copy is never replaced."), kind="info")
